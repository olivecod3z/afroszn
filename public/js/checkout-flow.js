                    ...
                    <div class="checkout-content step-3">
                        <div class="checkout-left">
                            ...
                            <div class="payment-methods">
                                <button class="payment-method active" type="button" onclick="checkoutFlow.selectPayment(this, 'card')">
                                ...
                                <button class="payment-method" type="button" onclick="checkoutFlow.selectPayment(this, 'gpay')">
                                ...
                                <button class="payment-method" type="button" onclick="checkoutFlow.selectPayment(this, 'applepay')">
                                ...
                                <button class="payment-method" type="button" onclick="checkoutFlow.selectPayment(this, 'paypal')">
